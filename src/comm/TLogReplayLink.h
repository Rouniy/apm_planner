...
#include "MAVLinkMessageMetaType.h"
#include <atomic>
#include <QMutex>
...
public:
    ...
    void enableTimeouts() { }
signals:
    // Replay runs on its QThread. QGCMAVLinkLogPlayer queues this signal into
    // its GUI-thread multicast relay before any inspector view is updated.
