...
2. Continue the requested SETUP stream from the completed Heli, Frame Type and native current Compass parameter/onboard/large-vehicle pages; the next coherent Compass slice is the dedicated Compass/Motor route.
